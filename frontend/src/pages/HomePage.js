...
style={{
  ...
  transition: 'background 0.2s ease'
    ...
    >
      ...
      >
        <p>
          <strong>Rika</strong> is a <span style={{color:"red", fontWeight:"bold"}} > Mental Health Care Chatbot </span> and is here to provide you with a
        ...
        <p>
          ...
          <strong style={{color:"red"}}>Rika</strong> is available <span style={{color:"red", fontWeight:"bold"}} > 24/7 </span> to assist you with empathetic and personalized
          support.
        </p>
      </div>
